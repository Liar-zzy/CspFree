...
<form class="layui-form" action="">
    ...
    <div class="layui-row">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width:500px">
                <select name="city" lay-verify="required">
                    <option value=""></option>
                    <option value="0">第19次CCF</option>
                    <option value="1">第18次CCF</option>
                    <option value="2">第17次CCF</option>
                    <option value="3">第16次CCF</option>
                    <option value="4">第15次CCF</option>
                </select>
            </div>
        </div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" style="width:500px">
				<input type="text" name="title" required lay-verify="required" placeholder="请输入考试成绩" autocomplete="off" class="layui-input">
			</div>
		</div>
